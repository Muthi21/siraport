...
<body>
    <div class="container" style="color: black;">
        <center>
            ...
            <br /><br />
            <h1><b>LAPORAN HASIL BELAJAR PESERTA DIDIK<br>SEKOLAH MENENGAH PERTAMA<br>SMP NEGERI 1 ELELIM</b></h1>
        </center>
        <br><br><br><br>
        <center>
        ...
        <div class="row page-break">
            <br />
            <center>
                <h3 class="font-weight-bold text-uppercase mb-4">Catatan Akhir Semester</h3>
            </center>
            <div class="row">
                <div class="col-md-6">
            ...
            <br><br><br><br><br><br>
            <table width="100%" class="text-center font-weight-bold">
                <tr>
                    <td>
                        <center></center>
                    </td>
            ...
            <br><br><br><br>
            <center class="font-weight-bold">Rum Salak S.Pd</center>
        </div>
    </div>
</body>
